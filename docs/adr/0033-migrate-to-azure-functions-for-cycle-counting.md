# [ADR-0033] Migrate-to Azure-Functions for cycle-counting
...
We will use MongoDB for our cycle-counting needs. This technology provides the features we need and aligns with our team's expertise.
