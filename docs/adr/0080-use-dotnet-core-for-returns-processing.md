# [ADR-0080] Use DotNet-Core for returns-processing
...
| Date        | 2025-08-17 |
| Status      | Accepted |
| Deciders    | Frank Wilson, Carol Johnson, Frank Wilson |

## Context

Our returns-processing implementation needs to handle increasing scale and complexity. The current approach is becoming difficult to maintain and doesn't meet our performance requirements.
...
We will use OpenID-Connect for our returns-processing needs. This technology provides the features we need and aligns with our team's expertise.
...
- Improved scalability for returns-processing
