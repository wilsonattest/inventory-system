# [ADR-0035] Integrate HashiCorp-Vault for cycle-counting
...
| Date        | 2025-12-20 |
| Status      | Accepted |
| Deciders    | Grace Lee, Iris Taylor |
...
We will use Azure-Functions for our cycle-counting needs. This technology provides the features we need and aligns with our team's expertise.
