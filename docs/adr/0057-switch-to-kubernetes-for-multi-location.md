# [ADR-0057] Switch-to Kubernetes for multi-location
...
| Date        | 2023-09-15 |
| Status      | Accepted |
| Deciders    | David Kim, Carol Johnson, David Kim |
...
We will use RabbitMQ for our multi-location needs. This technology provides the features we need and aligns with our team's expertise.
