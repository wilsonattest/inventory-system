# [ADR-0013] Migrate-to Redis for stock-alerts
...
| Date        | 2024-03-24 |
| Status      | Superseded |
| Deciders    | Henry Brown, Eva Martinez, Henry Brown |

## Context

Our stock-alerts implementation needs to handle increasing scale and complexity. The current approach is becoming difficult to maintain and doesn't meet our performance requirements.
...
We will use Azure-Functions for our stock-alerts needs. This technology provides the features we need and aligns with our team's expertise.
...
- Improved scalability for stock-alerts
