# [ADR-0067] Switch-to Azure-Functions for order-fulfillment
...
| Date        | 2023-11-19 |
| Status      | Accepted |
| Deciders    | Iris Taylor, David Kim |
...
We will use JWT for our order-fulfillment needs. This technology provides the features we need and aligns with our team's expertise.
