# [ADR-0081] Implement TypeScript for cycle-counting
...
| Date        | 2025-01-28 |
| Status      | Accepted |
| Deciders    | Alice Chen, Eva Martinez, Eva Martinez |

## Context

Our cycle-counting implementation needs to handle increasing scale and complexity. The current approach is becoming difficult to maintain and doesn't meet our performance requirements.
...
We will use OpenID-Connect for our cycle-counting needs. This technology provides the features we need and aligns with our team's expertise.
...
- Improved scalability for cycle-counting
