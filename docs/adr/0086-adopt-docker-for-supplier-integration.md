# [ADR-0086] Adopt Docker for supplier-integration
...
We will use MongoDB for our supplier-integration needs. This technology provides the features we need and aligns with our team's expertise.
