# [ADR-0054] Migrate-to PostgreSQL for barcode-scanning
...
| Date        | 2024-01-11 |
| Status      | Accepted |
| Deciders    | Bob Smith, Henry Brown, Henry Brown |
...
We will use Redis for our barcode-scanning needs. This technology provides the features we need and aligns with our team's expertise.
