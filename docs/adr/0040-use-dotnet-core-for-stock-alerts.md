# [ADR-0040] Use DotNet-Core for stock-alerts
...
We will use PostgreSQL for our stock-alerts needs. This technology provides the features we need and aligns with our team's expertise.
