# [ADR-0029] Migrate-to WebSockets for cycle-counting
...
| Date        | 2024-04-17 |
| Status      | Proposed |
| Deciders    | Jack Anderson, Frank Wilson, Bob Smith |
...
We will use Python for our cycle-counting needs. This technology provides the features we need and aligns with our team's expertise.
