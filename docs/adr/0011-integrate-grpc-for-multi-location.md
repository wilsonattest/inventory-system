# [ADR-0011] Integrate gRPC for multi-location
...
We will use Elasticsearch for our multi-location needs. This technology provides the features we need and aligns with our team's expertise.
