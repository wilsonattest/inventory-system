# [ADR-0084] Standardize-on REST-API for stock-tracking
...
| Date        | 2024-07-16 |
| Status      | Accepted |
| Deciders    | Grace Lee, Jack Anderson |
...
We will use Redis for our stock-tracking needs. This technology provides the features we need and aligns with our team's expertise.
