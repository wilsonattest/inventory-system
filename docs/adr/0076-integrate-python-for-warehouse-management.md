# [ADR-0076] Integrate Python for warehouse-management
...
We will use Kafka for our warehouse-management needs. This technology provides the features we need and aligns with our team's expertise.
