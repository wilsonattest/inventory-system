# [ADR-0053] Choose Python for stock-alerts
...
We will use Redis for our stock-alerts needs. This technology provides the features we need and aligns with our team's expertise.
