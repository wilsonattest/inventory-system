# [ADR-0034] Implement PostgreSQL for supplier-integration
...
We will use Azure-Functions for our supplier-integration needs. This technology provides the features we need and aligns with our team's expertise.
