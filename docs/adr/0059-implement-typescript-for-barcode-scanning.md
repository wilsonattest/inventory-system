# [ADR-0059] Implement TypeScript for barcode-scanning
...
We will use Python for our barcode-scanning needs. This technology provides the features we need and aligns with our team's expertise.
