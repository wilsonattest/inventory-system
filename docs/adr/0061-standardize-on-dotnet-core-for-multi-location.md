# [ADR-0061] Standardize-on DotNet-Core for multi-location
...
| Date        | 2023-08-10 |
| Status      | Proposed |
| Deciders    | Henry Brown, Alice Chen |
...
We will use AWS-Lambda for our multi-location needs. This technology provides the features we need and aligns with our team's expertise.
