# [ADR-0006] Integrate OpenID-Connect for inventory-forecasting
...
| Date        | 2024-10-02 |
| Status      | Proposed |
| Deciders    | Eva Martinez, Bob Smith, Grace Lee |

## Context

Our inventory-forecasting implementation needs to handle increasing scale and complexity. The current approach is becoming difficult to maintain and doesn't meet our performance requirements.
...
We will use Elasticsearch for our inventory-forecasting needs. This technology provides the features we need and aligns with our team's expertise.
...
- Improved scalability for inventory-forecasting
