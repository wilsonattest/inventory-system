# [ADR-0002] Adopt PostgreSQL for order-fulfillment
...
We will use AWS-Lambda for our order-fulfillment needs. This technology provides the features we need and aligns with our team's expertise.
