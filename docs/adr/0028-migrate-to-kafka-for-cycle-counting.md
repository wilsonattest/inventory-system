# [ADR-0028] Migrate-to Kafka for cycle-counting
...
We will use HashiCorp-Vault for our cycle-counting needs. This technology provides the features we need and aligns with our team's expertise.
