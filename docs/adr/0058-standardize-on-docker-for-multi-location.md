# [ADR-0058] Standardize-on Docker for multi-location
...
We will use Node.js for our multi-location needs. This technology provides the features we need and aligns with our team's expertise.
