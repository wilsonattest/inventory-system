# [ADR-0055] Choose Redis for returns-processing
...
We will use Terraform for our returns-processing needs. This technology provides the features we need and aligns with our team's expertise.
