# [ADR-0005] Migrate-to Redis for multi-location
...
We will use PostgreSQL for our multi-location needs. This technology provides the features we need and aligns with our team's expertise.
