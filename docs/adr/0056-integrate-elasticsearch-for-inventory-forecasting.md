# [ADR-0056] Integrate Elasticsearch for inventory-forecasting
...
We will use TypeScript for our inventory-forecasting needs. This technology provides the features we need and aligns with our team's expertise.
