# [ADR-0032] Use JWT for cycle-counting
...
We will use GitHub-Actions for our cycle-counting needs. This technology provides the features we need and aligns with our team's expertise.
