# [ADR-0041] Choose OAuth-2.0 for inventory-valuation
...
| Date        | 2024-12-08 |
| Status      | Superseded |
| Deciders    | Frank Wilson, Alice Chen |
...
We will use REST-API for our inventory-valuation needs. This technology provides the features we need and aligns with our team's expertise.
