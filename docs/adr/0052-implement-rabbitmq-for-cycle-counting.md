# [ADR-0052] Implement RabbitMQ for cycle-counting
...
We will use GraphQL for our cycle-counting needs. This technology provides the features we need and aligns with our team's expertise.
