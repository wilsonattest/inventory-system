# [ADR-0062] Standardize-on PostgreSQL for batch-management
...
| Date        | 2025-01-01 |
| Status      | Accepted |
| Deciders    | Alice Chen, Iris Taylor, Eva Martinez |

## Context

Our batch-management implementation needs to handle increasing scale and complexity. The current approach is becoming difficult to maintain and doesn't meet our performance requirements.
...
We will use Elasticsearch for our batch-management needs. This technology provides the features we need and aligns with our team's expertise.
...
- Improved scalability for batch-management
