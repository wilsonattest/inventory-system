# [ADR-0050] Deploy Terraform for supplier-integration
...
We will use Python for our supplier-integration needs. This technology provides the features we need and aligns with our team's expertise.
