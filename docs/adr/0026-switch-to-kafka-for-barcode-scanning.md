# [ADR-0026] Switch-to Kafka for barcode-scanning
...
We will use RabbitMQ for our barcode-scanning needs. This technology provides the features we need and aligns with our team's expertise.
