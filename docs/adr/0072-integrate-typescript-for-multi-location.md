# [ADR-0072] Integrate TypeScript for multi-location
...
We will use GraphQL for our multi-location needs. This technology provides the features we need and aligns with our team's expertise.
