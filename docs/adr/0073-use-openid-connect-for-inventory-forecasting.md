# [ADR-0073] Use OpenID-Connect for inventory-forecasting
...
We will use DotNet-Core for our inventory-forecasting needs. This technology provides the features we need and aligns with our team's expertise.
