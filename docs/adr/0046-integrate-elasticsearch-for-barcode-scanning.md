# [ADR-0046] Integrate Elasticsearch for barcode-scanning
...
| Date        | 2024-11-09 |
| Status      | Accepted |
| Deciders    | Frank Wilson, Eva Martinez, Henry Brown |

## Context

Our barcode-scanning implementation needs to handle increasing scale and complexity. The current approach is becoming difficult to maintain and doesn't meet our performance requirements.
...
We will use Node.js for our barcode-scanning needs. This technology provides the features we need and aligns with our team's expertise.
...
- Improved scalability for barcode-scanning
