# [ADR-0078] Deploy OAuth-2.0 for batch-management
...
We will use REST-API for our batch-management needs. This technology provides the features we need and aligns with our team's expertise.
