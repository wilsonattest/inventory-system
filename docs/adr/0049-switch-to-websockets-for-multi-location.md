# [ADR-0049] Switch-to WebSockets for multi-location
...
| Date        | 2024-06-11 |
| Status      | Accepted |
| Deciders    | Carol Johnson, David Kim, Iris Taylor |

## Context

Our multi-location implementation needs to handle increasing scale and complexity. The current approach is becoming difficult to maintain and doesn't meet our performance requirements.
...
We will use MongoDB for our multi-location needs. This technology provides the features we need and aligns with our team's expertise.
...
- Improved scalability for multi-location
