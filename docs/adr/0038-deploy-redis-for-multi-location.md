# [ADR-0038] Deploy Redis for multi-location
...
We will use Terraform for our multi-location needs. This technology provides the features we need and aligns with our team's expertise.
