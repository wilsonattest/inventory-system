# [ADR-0042] Switch-to React for stock-tracking
...
We will use React for our stock-tracking needs. This technology provides the features we need and aligns with our team's expertise.
