# [ADR-0082] Migrate-to REST-API for returns-processing
...
We will use REST-API for our returns-processing needs. This technology provides the features we need and aligns with our team's expertise.
