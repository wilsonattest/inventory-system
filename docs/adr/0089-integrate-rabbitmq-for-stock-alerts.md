# [ADR-0089] Integrate RabbitMQ for stock-alerts
...
We will use MongoDB for our stock-alerts needs. This technology provides the features we need and aligns with our team's expertise.
