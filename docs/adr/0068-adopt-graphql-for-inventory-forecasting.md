# [ADR-0068] Adopt GraphQL for inventory-forecasting
...
We will use Vue.js for our inventory-forecasting needs. This technology provides the features we need and aligns with our team's expertise.
