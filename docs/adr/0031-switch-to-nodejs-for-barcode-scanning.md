# [ADR-0031] Switch-to Node.js for barcode-scanning
...
We will use Elasticsearch for our barcode-scanning needs. This technology provides the features we need and aligns with our team's expertise.
