# [ADR-0020] Use AWS-Lambda for stock-tracking
...
| Date        | 2024-02-24 |
| Status      | Proposed |
| Deciders    | Grace Lee, Iris Taylor, Grace Lee |
...
We will use GitHub-Actions for our stock-tracking needs. This technology provides the features we need and aligns with our team's expertise.
