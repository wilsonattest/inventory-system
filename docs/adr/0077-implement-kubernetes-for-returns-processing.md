# [ADR-0077] Implement Kubernetes for returns-processing
...
| Date        | 2024-09-26 |
| Status      | Accepted |
| Deciders    | Iris Taylor, David Kim, David Kim |
...
We will use Azure-Functions for our returns-processing needs. This technology provides the features we need and aligns with our team's expertise.
