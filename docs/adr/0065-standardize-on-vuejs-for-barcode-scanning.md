# [ADR-0065] Standardize-on Vue.js for barcode-scanning
...
We will use Docker for our barcode-scanning needs. This technology provides the features we need and aligns with our team's expertise.
