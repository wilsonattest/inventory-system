# [ADR-0017] Adopt AWS-Lambda for order-fulfillment
...
| Date        | 2025-12-17 |
| Status      | Accepted |
| Deciders    | Bob Smith, Carol Johnson |
...
We will use Redis for our order-fulfillment needs. This technology provides the features we need and aligns with our team's expertise.
