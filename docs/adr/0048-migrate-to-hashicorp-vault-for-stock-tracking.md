# [ADR-0048] Migrate-to HashiCorp-Vault for stock-tracking
...
| Date        | 2025-12-07 |
| Status      | Accepted |
| Deciders    | David Kim, Eva Martinez, Frank Wilson |

## Context

Our stock-tracking implementation needs to handle increasing scale and complexity. The current approach is becoming difficult to maintain and doesn't meet our performance requirements.
...
We will use Azure-Functions for our stock-tracking needs. This technology provides the features we need and aligns with our team's expertise.
...
- Improved scalability for stock-tracking
