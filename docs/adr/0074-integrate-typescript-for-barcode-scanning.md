# [ADR-0074] Integrate TypeScript for barcode-scanning
...
We will use AWS-Lambda for our barcode-scanning needs. This technology provides the features we need and aligns with our team's expertise.
