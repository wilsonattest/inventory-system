# [ADR-0060] Migrate-to WebSockets for multi-location
...
| Date        | 2023-10-13 |
| Status      | Accepted |
| Deciders    | Frank Wilson, Iris Taylor, Jack Anderson |
...
We will use JWT for our multi-location needs. This technology provides the features we need and aligns with our team's expertise.
