# [ADR-0023] Migrate-to HashiCorp-Vault for warehouse-management
...
| Date        | 2023-06-01 |
| Status      | Proposed |
| Deciders    | Eva Martinez, Carol Johnson |

## Context

Our warehouse-management implementation needs to handle increasing scale and complexity. The current approach is becoming difficult to maintain and doesn't meet our performance requirements.
...
We will use Vue.js for our warehouse-management needs. This technology provides the features we need and aligns with our team's expertise.
...
- Improved scalability for warehouse-management
