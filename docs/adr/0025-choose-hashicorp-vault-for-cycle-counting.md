# [ADR-0025] Choose HashiCorp-Vault for cycle-counting
...
| Date        | 2023-04-27 |
| Status      | Proposed |
| Deciders    | David Kim, Alice Chen, Frank Wilson |
...
We will use REST-API for our cycle-counting needs. This technology provides the features we need and aligns with our team's expertise.
