# [ADR-0009] Switch-to Kafka for cycle-counting
...
We will use Node.js for our cycle-counting needs. This technology provides the features we need and aligns with our team's expertise.
