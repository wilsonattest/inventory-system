# [ADR-0069] Choose GitHub-Actions for stock-tracking
...
We will use AWS-Lambda for our stock-tracking needs. This technology provides the features we need and aligns with our team's expertise.
