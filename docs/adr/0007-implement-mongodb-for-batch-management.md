# [ADR-0007] Implement MongoDB for batch-management
...
We will use PostgreSQL for our batch-management needs. This technology provides the features we need and aligns with our team's expertise.
