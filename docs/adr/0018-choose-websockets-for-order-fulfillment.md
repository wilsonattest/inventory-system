# [ADR-0018] Choose WebSockets for order-fulfillment
...
| Date        | 2024-10-12 |
| Status      | Accepted |
| Deciders    | Jack Anderson, Eva Martinez, Frank Wilson |
...
We will use PostgreSQL for our order-fulfillment needs. This technology provides the features we need and aligns with our team's expertise.
