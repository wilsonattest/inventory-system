# [ADR-0003] Deploy HashiCorp-Vault for returns-processing
...
| Date        | 2024-10-03 |
| Status      | Proposed |
| Deciders    | Frank Wilson, Henry Brown, Frank Wilson |
...
We will use Docker for our returns-processing needs. This technology provides the features we need and aligns with our team's expertise.
