# [ADR-0075] Use Vue.js for returns-processing
...
We will use GraphQL for our returns-processing needs. This technology provides the features we need and aligns with our team's expertise.
