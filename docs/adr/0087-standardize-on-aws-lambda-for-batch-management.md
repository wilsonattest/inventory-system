# [ADR-0087] Standardize-on AWS-Lambda for batch-management
...
We will use RabbitMQ for our batch-management needs. This technology provides the features we need and aligns with our team's expertise.
