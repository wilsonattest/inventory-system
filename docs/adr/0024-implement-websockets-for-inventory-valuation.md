# [ADR-0024] Implement WebSockets for inventory-valuation
...
| Date        | 2024-01-25 |
| Status      | Accepted |
| Deciders    | Jack Anderson, Bob Smith, David Kim |

## Context

Our inventory-valuation implementation needs to handle increasing scale and complexity. The current approach is becoming difficult to maintain and doesn't meet our performance requirements.
...
We will use OpenID-Connect for our inventory-valuation needs. This technology provides the features we need and aligns with our team's expertise.
...
- Improved scalability for inventory-valuation
