# [ADR-0085] Integrate Docker for cycle-counting
...
| Date        | 2023-11-09 |
| Status      | Deprecated |
| Deciders    | Jack Anderson, Carol Johnson, Carol Johnson |
...
We will use Terraform for our cycle-counting needs. This technology provides the features we need and aligns with our team's expertise.
