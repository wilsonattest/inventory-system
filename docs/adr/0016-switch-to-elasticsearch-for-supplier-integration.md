# [ADR-0016] Switch-to Elasticsearch for supplier-integration
...
| Date        | 2024-06-03 |
| Status      | Superseded |
| Deciders    | Eva Martinez, Alice Chen |
...
We will use gRPC for our supplier-integration needs. This technology provides the features we need and aligns with our team's expertise.
