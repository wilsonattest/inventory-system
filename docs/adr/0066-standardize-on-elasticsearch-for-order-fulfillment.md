# [ADR-0066] Standardize-on Elasticsearch for order-fulfillment
...
| Date        | 2023-03-21 |
| Status      | Proposed |
| Deciders    | Frank Wilson, Frank Wilson |

## Context

Our order-fulfillment implementation needs to handle increasing scale and complexity. The current approach is becoming difficult to maintain and doesn't meet our performance requirements.
...
We will use Elasticsearch for our order-fulfillment needs. This technology provides the features we need and aligns with our team's expertise.
...
- Improved scalability for order-fulfillment
