# [ADR-0036] Standardize-on Kafka for inventory-valuation
...
We will use DotNet-Core for our inventory-valuation needs. This technology provides the features we need and aligns with our team's expertise.
